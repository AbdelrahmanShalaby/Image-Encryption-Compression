    ...
    static class Program
    {
        ...
        public static void all_possible()
        {
            for (int f = 0; f < all_sz; f++)
            {
                ...
                ImageBMP.Save(@"C:\Users\Abdelrahman\Desktop\Final-IsA_1 - Copy (4) - Copy - Copy\Final IsA\TEMPLATE-ImageEncryptCompress_4\[TEMPLATE] ImageEncryptCompress\ImageEncryptCompress\bin\images/" + all[f].S + "_" + Convert.ToString(all[f].T) + ".bmp");
        ...
        public static void ApplyEncryptionOrDecryption1()
        {
            ...
            ImageBMP.Save(@"C:\Users\Abdelrahman\Desktop\[TEMPLATE] ImageEncryptCompress\Put Pictures/" + index_vedio_res+ ".bmp");
            index_vedio_res++;
        }
